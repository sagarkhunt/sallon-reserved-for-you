...
@section('content')
        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="float-right mt-1">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Gastronomy Category</li>
                </ol>
            </nav>
            <h4 class="mb-1 mt-0">Edit Gastronomy Category</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-1">Edit Gastronomy Category</h4>

                    <hr/>

                    {{Form::open(array('url'=>'master-admin/category/'.$data['id'],'method'=>'PUT','name'=>'edit-category','files'=>'true','class'=>'needs-validation','novalidate'))}}
                    <div class="row">
                        <div class="col-lg-4">
