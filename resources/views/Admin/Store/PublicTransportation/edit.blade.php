        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {{Form::open(array('url'=>'master-admin/store-profile/'.$id.'/public-transportation/'.$data['id'],'method'=>'PUT','name'=>'Edit-public-transportation','files'=>'true','class'=>'needs-validation','novalidate'))}}
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <a href="{{URL::to('master-admin/store-profile/'.$id.'/public-transportation')}}" class="btn btn-danger">Cancel</a>
                    {{Form::close()}}
