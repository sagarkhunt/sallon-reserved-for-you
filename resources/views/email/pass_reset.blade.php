												   ...
												   <tr>
													<td align="center" style="padding:0px 5px 0 5px;">
														<table cellspacing="0" cellpadding="10">	
															<tr>
																<td>
																	<h1 style="color: #707070; margin: 0; font-family: Arial Black,Arial,Helvetica; text-align: center; font-size: 25px;">Hello,</h1>
																</td>
															</tr>

															<tr>
																<td style="font-family: Arial,Helvetica;">
                                                <p style="margin: 5px 0 10px 0; font-size: 15px;"><b>Name :</b> {{ $name }}</p>
																	<p style="margin: 5px 0 10px 0; font-size: 15px;"><b>New Pin :</b> {{ $password }}</p>
																	<p style="margin: 5px 0 10px 0; font-size: 15px;"><b>Email Address :</b> {{ $email }}</p>
